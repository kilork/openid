...
#[derive(Default)]
pub struct Options {
    /// MUST contain openid. By default this is ONLY openid. Official optional
    /// scopes are email, profile, address, phone, offline_access. Check the
    /// Discovery config `scopes_supported` to see what is available at your
    /// provider!
