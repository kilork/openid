...
```toml
[dependencies]
openid = { version = "0.24", default-features = false, features = ["rustls"] }
```
...
See full example: [openid-examples: warp](https://github.com/kilork/openid-examples/blob/v0.24/examples/warp.rs)
