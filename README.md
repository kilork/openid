...
```toml
[dependencies]
openid = { version = "0.21", default-features = false, features = ["rustls"] }
```
...
```toml
[dependencies]
openid = { version = "0.21", default-features = false, features = ["rustls-native-certs"] }
```
...
See full example: [openid-examples: warp](https://github.com/kilork/openid-examples/blob/v0.21/examples/warp.rs)
